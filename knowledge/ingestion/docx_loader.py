...
Frozen Part-3 path delegating to canonical DocxIngestionAdapter.
"""
...
def load_docx(
    ...
    *,
    ...
    """Load a DOCX file from a local path via the canonical ingestion adapter."""

    active_vault = vault or InMemorySourceVault()
    adapter = DocxIngestionAdapter(active_vault)
